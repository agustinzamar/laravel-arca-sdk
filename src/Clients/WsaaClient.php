...
class WsaaClient
{
    ...
    protected function createTra(WebService|string $service): string
    {
        ...
        $header->addChild('expirationTime', gmdate('c', time() + config('arca-sdk.cache_ttl')));
    ...
    protected function signTra(string $traPath): string
    {
        ...
        $certificatePath = $this->getFilePath(config('arca-sdk.public_cert'));
        $keyPath = $this->getFilePath(config('arca-sdk.private_key'));
    ...
    {
        return config('arca-sdk.cache_key');
    }

    protected function ttl(): int
    {
        return config('arca-sdk.cache_ttl');
    }
}
